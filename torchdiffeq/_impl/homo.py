...
def homoint(func, z0, x, t, *, rtol=1e-7, atol=1e-9, method=None, options=None, event_fn=None):
    ...
    shapes, func, z0, t, rtol, atol, method, options, event_fn, t_is_reversed = _check_inputs(func, z0, t, rtol, atol, method, options, event_fn, SOLVERS)

    solver = SOLVERS[method](func=func, y0=z0, rtol=rtol, atol=atol, **options)
...
def homoint_event(func, y0, t0, *, event_fn, reverse_time=False, odeint_interface=homoint, **kwargs):
